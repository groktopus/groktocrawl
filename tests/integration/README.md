...
timeout and is an external signal, not a deterministic adapter gate. Run it
explicitly with `pytest -m external`; external failures retain observed status,
body, and exception diagnostics.
